...
namespace UI
{
    public class UIMainMenu : UIScreen
    {
        ...
        public override string ScreenName { get; set; } = Core.UIService.Keys.UIKeys.KEY_MAIN_MENU_UI;
        ...
        protected override void Awake()
        {
            ...
            {
                _gameService.StartGame(); // Will handle scene loading
            });

            _settingsButton.onClick.AddListener(() =>
            {
                _uiService.ShowScreen(Core.UIService.Keys.UIKeys.KEY_SETTINGS_UI);
                _uiService.RemoveScreen(Core.UIService.Keys.UIKeys.KEY_MAIN_MENU_UI);
            });
        }
    }
}